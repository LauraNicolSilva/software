...
export default function CarritoScreen() {
     ...
     * style -> osupa todo el alto disponoble depende el celular ios, android
     * contentContainerStyle -> aplica padding y el gad al contenido interno
     */
        ...
        <>
          ...
          <View style={styles.sectionCard}>
            ...
            <View style={styles.sectionHeader}>
              ...
              <Pressable style={styles.vaciarBtn} onPress={handlerVaciarCarrito}>
          ...
          <View style={styles.summaryCard}>
            ...
            <Pressable style={styles.checkoutBtn} onPress={handlerIrACheckout}>
