...
export default function TabTwoScreen() {
    const { user, isAuthenticated, isLoadingSession, login, register, logout, updatePerfil } = useAuth() as unknown as AuthCtx;
    ...
    const handleGuardarPerfil = async () => {
        ...
        try {
            //solo se envia los campos que tiene valor los vacios se emiten
            ...
            setEditMode(false); // cierrre en el formulario de edicion 
